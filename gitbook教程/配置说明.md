# 配置说明
本文中的配置从 [原配置文档地址](http://gitbook.zhangjikai.com/bookjson.html) 复制而来,这里根据需要做了些修改
...
```json
{
    ...
    "plugins": [
        ...
        "-livereload",
        "search-plus@^0.0.11",
        "simple-page-toc@^0.1.1", //可生成目录 
        "github@^2.0.0",//github 链接
        "github-buttons@2.1.0", //显示github中的按钮
        "edit-link@^2.0.2",
        "disqus@^0.1.0",
        "prism@^2.1.0",
        "prism-themes@^0.0.2",
        ...
        "sharing-plus@^0.0.2",
        "graph@^0.1.0",
        "chart@^0.2.0"  //c3.js或者highchart绘图
    ],
